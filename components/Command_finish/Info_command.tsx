    ...
    <div className={style.info_commande}>
      <div className={style.info_card}>
        ...
        <div className={style.card_content}>
          <div className={style.info_item}>
            ...
            <span className={style.info_value}>{bot.bot_view.name || t("not_specified")}</span>
          </div>
          
          <div className={style.info_item}>
            <span className={style.info_label}>{t("commands_count")}</span>
            <span className={style.info_value}>
              <span className={style.count_badge}>{bot.command?.length || 0}</span>
            </span>
          </div>
          ...
          <div className={style.info_item}>
            ...
            <span className={style.info_value}>
              {bot.bot_view.host === "true" ? (
                <span className={style.host_badge_self}>{t("self_hosted")}</span>
              ) : (
                <span className={style.host_badge_service}>{t("service_hosted")}</span>
              )}
            </span>
          </div>
        ...
        <div className={style.tech_info}>
          <h3>
            <svg className={style.tech_icon} width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        <div className={style.form_header}>
          <svg className={style.contact_icon} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={style.input_container}>
              <div className={style.input_icon}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19.27 5.33C17.94 4.71 16.5 4.26 15 4C14.89 4.23 14.76 4.57 14.68 4.85C13.09 4.61 11.51 4.61 9.95 4.85C9.87 4.57 9.73 4.23 9.62 4C8.12 4.26 6.67 4.71 5.34 5.33C2.22 9.97 1.33 14.5 1.77 18.97C3.49 20.29 5.33 21 7.24 21.33C7.76 20.61 8.21 19.84 8.58 19.03C7.94 18.79 7.33 18.5 6.76 18.15C6.94 18.01 7.12 17.86 7.29 17.71C10.84 19.35 14.73 19.35 18.24 17.71C18.42 17.86 18.59 18.01 18.77 18.15C18.2 18.5 17.59 18.79 16.95 19.03C17.32 19.84 17.76 20.61 18.29 21.33C20.2 21 22.04 20.29 23.76 18.97C24.28 13.87 22.89 9.37 19.27 5.33ZM8.55 16.01C7.43 16.01 6.5 14.95 6.5 13.66C6.5 12.37 7.4 11.31 8.55 11.31C9.7 11.31 10.63 12.37 10.6 13.66C10.6 14.95 9.7 16.01 8.55 16.01ZM15.45 16.01C14.33 16.01 13.4 14.95 13.4 13.66C13.4 12.37 14.3 11.31 15.45 11.31C16.6 11.31 17.53 12.37 17.5 13.66C17.5 14.95 16.6 16.01 15.45 16.01Z" fill="currentColor"/>
                </svg>
              </div>
              <input
                type="text"
        ...
        <button type="submit" className={style.submit_button}>
          <span>{t("finish")}</span>
          <svg className={style.button_icon} width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
